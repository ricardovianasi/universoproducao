...
(function(window, $) {
    ...
    NestableSerialize.prototype = {
        ...
        addNode: function(id, text) {
            var _that = this;
            var el = $('<li class="dd-item" data-id="' + id + '">').append('<div class="item-controls"><a class="' + _that.config.removeEventSelector.replace(".", "") + '" role="button">excluir</a></div>').append('<div class="dd-handle"><span class="item-title">' + text + "</span></div>");
            $(".dd-list", _that.$element).append(el);
        }
    };
