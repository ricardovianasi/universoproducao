...
class MovieRegistrationController extends AbstractMeuUniversoRegisterController
{
    ...
    public function editarInscricaoAction()
    {
        ...
        if($this->getRequest()->isPost()) {
            ...
            $msg.= '<p>O resultado para a seleção da 23ª Mostra Tiradentes está previsto para a primeira quinzena de janeiro de 2020, e o da 15ª CineOP para o a primeira quinzena de junho de 2020. Os resultados serão enviados para o e-mail cadastrado.</p>';
        ...
        if($this->getRequest()->isPost()) {
            ...
            if($form->isValid()) {
                ...
                if(!$id) {
                    ...
                    $msg.= '<p>O resultado para a seleção da 24ª Mostra Tiradentes está previsto para a primeira quinzena de janeiro de 2021 e da 16ª CineOP para a primeira quinzena de junho de 2021. Os resultados serão enviados para o e-mail cadastrado.</p>';
                    $msg.= '<p>Pedimos a gentileza de manter os dados do seu cadastro sempre atualizados para garantir a eficácia em nossa comunicação.</p>';
                    $msg.= '<p>Agradecemos a participação!</p>';
