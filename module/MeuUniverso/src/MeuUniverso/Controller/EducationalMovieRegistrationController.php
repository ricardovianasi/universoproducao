...
use MeuUniverso\Form\EducationalMovieForm;
use MeuUniverso\Form\MovieForm;
use Zend\View\Model\ViewModel;
use Zend\View\View;

class EducationalMovieRegistrationController extends AbstractMeuUniversoRegisterController
{
    ...
    protected function persist($method)
    {
        ...
        $form = new EducationalMovieForm($this->getEntityManager(), $reg);
        ...
        if($this->getRequest()->isPost()) {
            ...
            if($form->isValid()) {
                ...
                $movieEvent = new MovieSubscription();
                $movieEvent->setMovie($movie);
                $movieEvent->setEvent($reg->getEvent());
                $movieEvent->setRegistration($reg);
