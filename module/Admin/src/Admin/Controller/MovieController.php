	...
	implements CrudInterface, PostInterface
{
    ...
    {
        $items = $this->search(Movie::class, ['status'=>Status::NOT_SELECTED], ['createdAt' => 'DESC'], true);
        ...
        foreach ($items as $item) {
            ...
            //$this->mailService()->simpleSendEmail($to, 'Filmes - 21ª Mostra de Cinema de Tiradentes', $msg);
