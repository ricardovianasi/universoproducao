...
class PostController extends SiteController
{
    ...
    public function credenciamentoAction()
    {
        ...
        if($this->getRequest()->isPost()) {
            ...
            $msgConfirmacaoCadastro = "Informamos que sua solicitação de credenciamento de imprensa para o Arquivo em Cartaz 2016 foi enviada com sucesso.";
            ...
            $msgConfirmacaoCadastro .= "Equipe Imprensa – Arquivo em Cartaz<br />";
            $msgConfirmacaoCadastro .= "www.arquivoemcartaz.com.br<br />";
            ...
            $mailConfirmacao->setSubject('Solicitação de credenciamento – Arquivo em Cartaz');
            ...
            $mail->setSubject('Credenciamento de Imprensa - Arquivo em Cartaz');
