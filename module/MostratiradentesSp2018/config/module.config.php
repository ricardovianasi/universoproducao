<?php
namespace MostratiradentesSp2018;
...
return array(
    'router' => array(
        ...
        'routes' => array(
            'mostratiradentessp2018' => array(
                'type'    => Hostname::class,
                'options' => array(
                    'route'    => '[www.]2018.mostratiradentessp.com.br',
                    'defaults' => array(
    ...
    'view_manager' => array(
        'template_map' => array(
            'mostratiradentessp2018/layout' => __DIR__ . '/../view/layout/layout.phtml',
        ),
    ...
    'module_layouts' => [
        __NAMESPACE__ => 'mostratiradentessp2018/layout'
    ]
);
